...
public class ClassLoaderTest {
  public static void main(String[] args) throws Exception {
    ...
    Object obj = myLoader.loadClass("dizoo.std.jvm.classLoad.classloader.ClassLoaderTest").newInstance();
    ...
    Object obj2=myLoader.loadClass("dizoo.std.jvm.classLoad.classloader.Package").newInstance();
